...
public class CSharpCallCpp : MonoBehaviour
{
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //Int
    ...
    void TestStructures()
    {
        ...
        int arraySize = 0;
        IntPtr dataPtr = ReturnArrayOfPoints(ref arraySize);
    ...
    //Callback
    [DllImport("YGarmentLib")]
    private static extern long TestOpencv();

    [DllImport("YGarmentLib")]
    private static extern void TestCallback(CSCallback callback);
